...
X_train =np.concatenate((X_train, np.load('X_train_augmented.npy'))) 
y_train = np.concatenate((y_train, np.load('y_train_augmented.npy')))
...
# Save the model
model.save('entanglement_model_V2.h5')

# Save the training history
np.save('train_history_V2.npy', history.history)
